-- Enable required PostgreSQL extensions for Kavíla.
...
SELECT 'CREATE DATABASE kavila_shadow OWNER kavila'
WHERE NOT EXISTS (SELECT FROM pg_database WHERE datname = 'kavila_shadow')\gexec
