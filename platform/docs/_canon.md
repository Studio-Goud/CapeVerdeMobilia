# DJARVISTA — PROJECT CANON (single source of truth)
...
## Brand
- Name: **Djarvista** (code namespace `djarvista`, packages `@djarvista/*`). Combines *djar* (island, in Kabuverdianu/Creole) + *vista* (view) — “island view”. To validate: trademark, domain, social handles (never present as guaranteed).
