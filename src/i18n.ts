...
const UI = {
  ...
  'dash.boostPayHint': { pt: 'Pedido enviado. Veja como pagar e ativamos em 24h.', en: 'Request sent. See how to pay and we activate within 24h.', nl: 'Aanvraag verstuurd. Bekijk hoe je betaalt, we activeren binnen 24u.' },
